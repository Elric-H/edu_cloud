...
<div class="second-level">
	<div class="box" ref="srcollBox">
		<div class="box-list clearfix" ref="srcoll">
			<div class="list launch clearfix">
				<div :class="{'e-active': curPage == 'launch'}" @click="toTargetPage('launch')">
			...
			<div class="list primary clearfix">
				<div :class="{'c-active': curPage == 'primary'}" @click="toTargetPage('primary')">
					<div class="left pull-left text-center">
			...
			<div class="list adjust clearfix">
				<div :class="{'s-active': curPage == 'adjust'}" @click="toTargetPage('adjust')">
					<div class="left pull-left text-center">
			...
			<div class="list divide clearfix">
				<div :class="{'h-active': curPage == 'divide'}" @click="toTargetPage('divide')">
					<div class="left pull-left text-center">
...
export default {
	name: 'second-level',
	mounted() {
		this.$refs.srcoll.style.left = '0px';
	},
	data() {
		return {
			curPage: 'launch'
