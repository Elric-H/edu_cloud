        ...
        <div class="box" ref="srcollBox">
            <div class="box-list clearfix" ref="srcoll">
                <div class="list enroll clearfix">
                    <div :class="{'e-active': curPage == 'canteen'}" @click="toTargetPage('canteen')">
                ...
                <div class="list credit clearfix">
                    <div :class="{'c-active': curPage == 'store'}" @click="toTargetPage('store')">
                        <div class="left pull-left text-center">
                ...
                <div class="list score clearfix">
                    <div :class="{'s-active': curPage == 'schoolAsset'}" @click="toTargetPage('schoolAsset')">
                        <div class="left pull-left text-center">
                ...
                <div class="list health clearfix">
                    <div :class="{'h-active': curPage == 'vehicle'}" @click="toTargetPage('vehicle')">
                        <div class="left pull-left text-center">
                ...
                <!--<div class="list card clearfix">-->
                    <!--<div :class="{'ca-active': curPage == 'myAsset'}" @click="toTargetPage('myAsset')">-->
                        <!--<div class="left pull-left text-center">-->
    ...
    export default {
        ...
        mounted() {
            ...
            switch (currentUrlName){
                /*食堂管理*/
                case "food":this.curPage='canteen';break;
                case "foodType":this.curPage='canteen';break;
                case "field":this.curPage='canteen';break;
                /*商店管理*/
                case "store":this.curPage='store';break;
                /*校产管理*/
                case "supplier":this.curPage='schoolAsset';break;
                case "asset":this.curPage='schoolAsset';break;
                /*车俩管理*/
                case "vehicle":this.curPage='vehicle';break;
                /*我的资产*/
                case "myAsset":this.curPage='myAsset';break;
            }
        },
        data() {
            return {
                curPage: 'canteen'  //用以记录当前子页面
            }
        },
        methods: {
            toTargetPage: function(name){
                this.curPage = name;
                var url="/schoolAffair/"+name;//处理跳转地址
            ...
            toDown: function(){
                ...
                let left = parseInt(this.$refs.srcoll.style.left);
                if((max - 1190) == left) return;
                if((max - 1190) <= (left - 234)) this.$refs.srcoll.style.left = (left - 234) + 'px';
                else this.$refs.srcoll.style.left = (max - 1190) + 'px';
            }
        }
    }
</script>
